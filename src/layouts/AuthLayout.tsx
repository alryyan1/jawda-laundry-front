...
const AuthLayout = () => {
  ...
  // Add auth-page class to body to prevent scroll
  useEffect(() => {
  ...
  return (
    <div 
      className="flex h-screen w-full flex-col items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden"
      style={{
    ...
    >
      ...
      {/* Decorative Elements */}
      <FloatingElement delay={0.5} className="absolute top-4 left-4 opacity-10">
        <ChefHat className="h-12 w-12 text-white" />
      </FloatingElement>
      <FloatingElement delay={1.5} className="absolute bottom-4 right-4 opacity-10">
      ...
      <div className="relative z-10 w-full max-w-md bg-background/95 backdrop-blur-md rounded-2xl p-4 shadow-2xl border border-white/10 animate-fade-in max-h-[85vh] overflow-y-auto">
        ...
        <div className="mb-4 flex flex-col items-center animate-slide-up">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <div className="text-left">
              <h1 className="text-2xl font-bold tracking-tight bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent">
      ...
      {/* Enhanced Footer */}
      <footer className="absolute bottom-2 text-center text-xs text-white/70 w-full z-10 animate-slide-up" style={{ animationDelay: '0.7s' }}>
