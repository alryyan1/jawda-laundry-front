...
import { Loader2, SlidersHorizontal, Utensils, Tag, Search, X } from 'lucide-react';
            ...
            <TableCell className="text-center">
                <div className="flex items-center justify-center gap-3">
                    <Avatar className="h-10 w-10 rounded-md">
                        ...
                        <AvatarFallback className="rounded-md bg-muted"><Utensils className="h-5 w-5 text-muted-foreground" /></AvatarFallback>
                    </Avatar>
                    <div>
