    ...
    return (
        <div className="max-w-5xl mx-auto">
            ...
            <div className="grid gap-4 md:grid-cols-3 mb-6">
                <StatCard title={t('totalDebits')} value={formatCurrency(summary.total_debits, currencyCode, i18n.language)} icon={TrendingUp} className="border-red-500/20" />
                <StatCard title={t('totalCredits')} value={formatCurrency(summary.total_credits, currencyCode, i18n.language)} icon={TrendingDown} className="border-green-500/20" />
                <StatCard title={t('currentBalance')} value={formatCurrency(summary.current_balance, currencyCode, i18n.language)} icon={FileText} className={cn(summary.current_balance > 0 ? "border-destructive" : "border-green-500/20")} />
            </div>
