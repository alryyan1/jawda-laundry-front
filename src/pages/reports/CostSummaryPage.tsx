...
const CostSummaryPage: React.FC = () => {
  ...
  const {
    ...
    isLoading,
    isFetching,
  } = useQuery<CostSummaryReport, Error>({
    queryKey,
    queryFn: () =>
    ...
    <div className="container mx-auto px-4 py-6 max-w-7xl">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 mb-6">
        ...
        <StatCard
          ...
          icon={FileText}
          value={
            report?.summary.total_expenses !== undefined
              ? formatCurrency(
        ...
        <StatCard
          ...
          icon={ShoppingCart}
          value={
            report?.summary.total_purchases !== undefined
              ? formatCurrency(
      ...
      <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t("purchasesBySupplier")}</CardTitle>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
