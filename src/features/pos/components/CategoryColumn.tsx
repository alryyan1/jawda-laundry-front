              ...
              >
                  {category.image_url ? (
                    <>
                      ...
                      />
                      <span
                        className="absolute left-1/2 bottom-1 whitespace-nowrap overflow-visible -translate-x-1/2 px-1 py-0.5 bg-white/80 dark:bg-black/50 border border-gray-300 dark:border-gray-600 rounded text-xs font-semibold text-gray-800 dark:text-gray-100 shadow"
                    ...
                    <div className="w-full h-full flex items-center justify-center p-1">
                      <span className="text-xs font-medium text-gray-800 dark:text-gray-100 text-center line-clamp-2 overflow-hidden">
                        {category.name}
                      </span>
                    </div>
                  )}
