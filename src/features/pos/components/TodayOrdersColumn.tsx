...
export const TodayOrdersColumn: React.FC<TodayOrdersColumnProps> = ({
  ...
  if (isLoading) {
    return (
      <div className="w-[120px] bg-background rounded-lg shadow-sm overflow-hidden flex flex-col">
        <div className="p-3 border-b" style={{ borderColor: materialColors.divider }}>
  ...
  return (
    <MuiThemeProvider theme={muiTheme}>
      <div className="w-[120px] bg-background rounded-lg shadow-sm overflow-hidden flex flex-col">
        ...
        {orders.length > 0 && (
          <div className="p-2 border-t" style={{ borderColor: materialColors.divider }}>
